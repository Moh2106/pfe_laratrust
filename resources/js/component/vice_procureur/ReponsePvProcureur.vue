              ...
              <form action="" @submit.prevent="save" class="w-2/3 mx-auto">
                <div class="flex justify-between">
                    <div class="text-right">
                        <label for="identifiant">معرف المحضر</label> <br>
                    ...
                    <div class="text-right">
                        ...
                        <input type="number" name="" id="numero_envoi" v-model="info.numero_envoi" class="rounded-lg text-right text-black">
                    </div>
...
export default {
  ...
  setup(){ 
      ...
      const {createPvReponse} = usePvReponse();

      const save = () => {
          createPvReponse({...info});
