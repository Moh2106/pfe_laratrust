            ...
            <div>
                <template v-for="pv in getFilteredPv" :key="pv.id">
                    <div class="bg-white text-black text-right rounded-lg p-2 see">
                        <h1><span v-text="pv.numero_envoi"></span>: رقم الإرسالية</h1>
                        <h1><span v-text="pv.vice_procureur_name"></span>: نائب وكيل الملك</h1>
                        <h1><span v-text="pv.reponse"></span>: جواب نائب وكيل الملك</h1>
                        <h1><span v-text="pv.created_at"></span>:  تاريخ الإرسال</h1>
                    </div>
                </template>
            </div>
      </div>
