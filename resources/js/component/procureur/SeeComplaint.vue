  ...
  <div class="see">
      ...
      <template v-for="plaintes in getFilteredPlainte" :key="plaintes.id">
        <div class="details p-4 block text-right bg-white text-black rounded-lg">
          ...
          <!---  <h1> <bdi><span v-text = "plaintes.prenom_plaignant1"></span> <span v-text = "plaintes.nom_plaignant1"></span></bdi> شكاية من نوع   <bdi><span v-text = "plaintes.type_de_la_plainte"></span></bdi>مسجلة من طرف  </h1>
                <h1><span v-text = "plaintes.source_de_la_plainte"></span>  مصدرها</h1> -->
            ...
            <button class="btn bg-green mt-2" >
